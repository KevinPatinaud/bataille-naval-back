...
public interface BoatRepository extends JpaRepository<Boat, Long> {
    ...
    @Query(value = "select BOAT.*  from PLAYER, BOAT where PLAYER.uid=BOAT.player and PLAYER.game=:idGame and PLAYER.id_player=:idPlayer and BOAT.is_destroyed=false ", nativeQuery = true)
    ArrayList<Boat> findAllNotDestroyedBoats(@Param("idGame") String idGame, @Param("idPlayer") IdPlayer idPlayer);
